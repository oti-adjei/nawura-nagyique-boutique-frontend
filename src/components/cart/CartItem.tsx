...
//       {/* Size */}
//       <div className="w-full md:text-center">{item.size}</div>
...
// //       {/* Product Image + Name */}
// //       <div className="flex items-center gap-4 md:col-span-2 w-full">
// //         <Image src={item.imageUrl} fill alt={item.name} className="w-24 h-24 object-cover" />
// //         <div className="text-sm font-medium">{item.name}</div>
// //       </div>
...
// //       {/* Quantity */}
// //       <div className="flex items-center gap-2 w-full md:justify-center">
// //         <button onClick={decreaseQty} className="px-2 py-1 bg-gray-200 rounded">-</button>
// //         <span>{quantity}</span>
// //         <button onClick={increaseQty} className="px-2 py-1 bg-gray-200 rounded">+</button>
// //       </div>
...
// //       {/* Delete / Action */}
// //       <div className="w-full flex justify-end md:justify-center">
// //         <button className="text-red-500 hover:underline">Remove Item</button>
// //       </div>
// //     </div>
// //   );
// // }
