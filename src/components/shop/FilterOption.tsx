...
// // --- TYPE DEFINITIONS ---
// type MainFilter = 'Clothing' | 'Purses' | 'Handbags' | 'Bracelets' | 'Shirts' | 'Necklace';
// type SubFilter = 'All' | 'Men' | 'Women';

// // --- DATA CONFIGURATION ---
// const filterConfig: Record<MainFilter, { subFilters: SubFilter[] | null }> = {
//   Clothing: { subFilters: ['All', 'Men', 'Women'] },
...
// // --- COMPONENT ---
// const FilterOptions = () => {
//   const [activeFilter, setActiveFilter] = useState<MainFilter | null>(null);
...
//   const handleSubFilterSelect = (mainFilter: MainFilter, subFilter: SubFilter) => {
//     setActiveFilter(mainFilter);
//     setActiveSubFilter(subFilter);
//     setHoveredFilter(null); // Hide dropdown on selection
//   };

//   const handleDirectSelect = (mainFilter: MainFilter) => {
//     setActiveFilter(mainFilter);
//     setActiveSubFilter('All');
//   };

//   return (
//     <div className="font-sans text-gray-400 p-6 md:p-10 w-full">
//       {/* Top Bar */}
//       <div className="flex justify-between items-center text-xs sm:text-sm mb-12">
//         <p className="tracking-wider">
//           <span className="cursor-pointer hover:text-white transition-colors">Home </span>
//           <span className="text-white ml-2 underline">Shop</span>
//         </p>
...
//       <div onMouseLeave={() => setHoveredFilter(null)} className="min-h-[100px]">
...
//                   onClick={!config.subFilters ? () => handleDirectSelect(filter) : undefined}
//                   className={`transition-all duration-300 font-semibold tracking-widest text-sm uppercase px-8 py-3 rounded-md
...
//                 {/* Conditionally render the sub-filter dropdown on hover */}
//                 {hoveredFilter === filter && config.subFilters && (
//                   <div
//                     className="absolute top-full mt-4 left-1/2 -translate-x-1/2 z-10 w-max"
//                   >
//                     {/* The container styles from your example are already here, with an added background for visibility */}
...
//                         <button
//                           key={subFilter}
//                           onClick={() => handleSubFilterSelect(hoveredFilter, subFilter)}
//                           // --- STYLE CHANGE IS HERE ---
//                           // This now matches the class structure from your example.
//                           className={`text-sm font-semibold transition-colors duration-300 ${
//                             activeFilter === hoveredFilter && activeSubFilter === subFilter
//                               ? 'text-[#9C193D]' // Active style
//                               : 'text-gray-500 hover:text-[#9C193D]' // Inactive style
//                           }`}
//                         >
//                           {subFilter}
//                         </button>
...
//       {activeFilter && (
//         <div className="flex items-center gap-4 text-sm mt-8 border-t border-gray-800 pt-6">
//           <span className="text-gray-400">Filtering by:</span>
//           <span className="flex items-center bg-gray-800 text-white font-semibold px-3 py-1 rounded-full">
//             {activeFilter}
//             {filterConfig[activeFilter]?.subFilters && activeSubFilter !== 'All' && (
//               <span className="ml-1 text-gray-400">/ {activeSubFilter}</span>
//             )}
//           </span>
//           <button
