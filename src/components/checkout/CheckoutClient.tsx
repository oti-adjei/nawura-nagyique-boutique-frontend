...
import type { CartItem as CheckoutCartItem, CheckoutFormData, PaymentMethod } from '@/types/checkout';
...
const CheckoutClient: React.FC<CheckoutClientProps> = ({
  ...
  // const [selectedState, setSelectedState] = useState(null);
    ...
    const [countries, setCountries] = useState<CountryEntity[]>(Country.getAllCountries() as CountryEntity[]);
